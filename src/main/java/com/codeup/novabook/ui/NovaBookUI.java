...
import com.codeup.novabook.utils.CsvExporter;
import com.codeup.novabook.utils.LoggerConfig;
...
public class NovaBookUI {
            ...
            switch (choice) {
                case 0: // Login
                    ...
                    if (email.isEmpty() || password.isEmpty()) {
                        JOptionPane.showMessageDialog(null, "Please enter both email and password.", "Login Error",
                                JOptionPane.ERROR_MESSAGE);
                        continue;
                    }
    ...
    private void registerMemberFromLogin() {
        try {
            ...
            int result = JOptionPane.showConfirmDialog(null, memberPanel, "Register as Member",
            ...
            if (result == JOptionPane.OK_OPTION) {
                ...
                if (emailExists) {
                    JOptionPane.showMessageDialog(null, "This email is already registered.", "Registration Error",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }
            ...
            JOptionPane.showMessageDialog(null, "Error registering member: " + e.getMessage(), "Error",
                    JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void createDefaultAdminUser() {
        try {
            ...
            if (adminExists) {
                JOptionPane.showMessageDialog(null, "Admin user already exists in the system.", "Admin User Exists",
                        JOptionPane.INFORMATION_MESSAGE);
                return;
            }
            ...
            int result = JOptionPane.showConfirmDialog(null, adminPanel, "Create Admin User",
                    JOptionPane.OK_CANCEL_OPTION);
            ...
            if (result == JOptionPane.OK_OPTION) {
                ...
                User adminUser = new User(1, name, email, password, phone, "ADMIN", "MANAGE", true, false,
                        Instant.now(), Instant.now());
                userService.registerUser(adminUser);

                JOptionPane.showMessageDialog(null, "Admin user created successfully!", "Success",
                        JOptionPane.INFORMATION_MESSAGE);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Error creating admin user: " + e.getMessage(), "Error",
                    JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void showMainMenu() {
        while (true) {
            ...
            switch (choice) {
                ...
                case 7:
                default:
                    JOptionPane.showMessageDialog(null, "Thank you for using NovaBook!", "Goodbye",
                            JOptionPane.INFORMATION_MESSAGE);
                    return;
            }
        }
     ...
     */
    /**
     * Shows the export menu with options to export different data to CSV
     */
    ...
    private void exportBookCatalog() {
        try {
            List<Book> books = bookService.getAllBooks();
            String filePath = "libros_export.csv";

            if (CsvExporter.exportBooksToCsv(books, filePath)) {
                JOptionPane.showMessageDialog(null,
                        "Book catalog successfully exported to: " + filePath,
                        "Export Successful",
                        JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(null,
                        "Failed to export book catalog",
                        "Export Failed",
                        JOptionPane.ERROR_MESSAGE);
            }
        } catch (Exception e) {
            LoggerConfig.getLogger().severe("Error exporting book catalog: " + e.getMessage());
            JOptionPane.showMessageDialog(null,
                    "Error exporting book catalog: " + e.getMessage(),
                    "Export Error",
                    JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void exportOverdueLoans() {
        try {
            List<Lending> overdueLoans = lendingService.getOverdueLoans();
            String filePath = "prestamos_vencidos.csv";

            if (overdueLoans.isEmpty()) {
                JOptionPane.showMessageDialog(null,
                        "There are no overdue loans to export",
                        "No Data",
                        JOptionPane.INFORMATION_MESSAGE);
                return;
            }

            if (CsvExporter.exportOverdueLendingsToCsv(overdueLoans, filePath)) {
                JOptionPane.showMessageDialog(null,
                        "Overdue loans successfully exported to: " + filePath,
                        "Export Successful",
                        JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(null,
                        "Failed to export overdue loans",
                        "Export Failed",
                        JOptionPane.ERROR_MESSAGE);
            }
        } catch (Exception e) {
            LoggerConfig.getLogger().severe("Error exporting overdue loans: " + e.getMessage());
            JOptionPane.showMessageDialog(null,
                    "Error exporting overdue loans: " + e.getMessage(),
                    "Export Error",
                    JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void showChangePasswordDialog() {
        ...
        int result = JOptionPane.showConfirmDialog(null, passwordPanel, "Change Password",
                JOptionPane.OK_CANCEL_OPTION);
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            if (!newPassword.equals(confirmPassword)) {
                JOptionPane.showMessageDialog(null, "New passwords do not match.", "Validation Error",
                        JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            if (success) {
                ...
                JOptionPane.showMessageDialog(null, "Failed to change password. Please check your current password.",
    ...
    private void returnBook() {
        try {
            ...
            if (lendingIdStr == null || lendingIdStr.trim().isEmpty())
                return;
    ...
    private void changeUserRole() {
        try {
            ...
            List<User> allUsers = userService.getAllUsers();
            if (allUsers.isEmpty()) {
                JOptionPane.showMessageDialog(null, "No users found.", "Change User Role",
                        JOptionPane.INFORMATION_MESSAGE);
                return;
            }
            ...
            for (int i = 0; i < allUsers.size(); i++) {
                ...
                userOptions[i] = "ID: " + user.getId() + " - " + user.getName() + " (" + user.getEmail() + ") - Role: "
                        + user.getRole();
            }
            ...
            String newRole = (String) JOptionPane.showInputDialog(null,
                    ...
                    null,
                    roleOptions,
                    currentRole.equals("USER") ? roleOptions[0]
                            : currentRole.equals("ADMIN") ? roleOptions[1] : roleOptions[2]);

            if (newRole == null)
                return;

            if (currentRole.equals(newRole)) {
                JOptionPane.showMessageDialog(null, "User already has this role.", "No Change",
                        JOptionPane.INFORMATION_MESSAGE);
                return;
            }
            ...
            // Confirm the change
            int confirm = JOptionPane.showConfirmDialog(null,
                    "Are you sure you want to change " + user.getName() + "'s role from " + currentRole + " to "
                            + newRole + "?",
                    "Confirm Role Change",
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                if (success) {
                    ...
                    JOptionPane.showMessageDialog(null, "Failed to change user role.", "Error",
                            JOptionPane.ERROR_MESSAGE);
                }
            }
    ...
    private void searchBooksForMember() {
        try {
            ...
            if (books.isEmpty()) {
                JOptionPane.showMessageDialog(null, "No books found matching your search.", "Search Results",
                        JOptionPane.INFORMATION_MESSAGE);
            } else {
                displayBooks(books);
            }
    ...
    private void borrowBook() {
        try {
            ...
            if (availableBooks.isEmpty()) {
                JOptionPane.showMessageDialog(null, "No books available for borrowing.", "No Books Available",
                        JOptionPane.INFORMATION_MESSAGE);
                return;
            }
            ...
            for (int i = 0; i < availableBooks.size(); i++) {
                ...
                bookOptions[i] = "ID: " + book.getId() + " - " + book.getTitle() + " by " + book.getAuthor()
                        + " (Stock: " + book.getStock() + ")";
            }
            ...
            if (daysStr != null && !daysStr.trim().isEmpty()) {
                try {
                    ...
                    if (lendingDays <= 0) {
                        JOptionPane.showMessageDialog(null, "Lending period must be positive.", "Invalid Input",
                                JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                } catch (NumberFormatException e) {
                    JOptionPane.showMessageDialog(null, "Invalid number format.", "Invalid Input",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }
            }
            ...
            synchronized (this) {
                ...
                if (!lendingService.canMemberBorrowMoreBooks(currentMember.getId(), 3)) {
                    JOptionPane.showMessageDialog(null, "You have reached the maximum number of borrowed books (3).",
    ...
    private void returnBookForMember() {
        try {
            ...
            activelendings = activelendings.stream().filter(lending -> !lending.isReturned())
                    .collect(java.util.stream.Collectors.toList());

            if (activelendings.isEmpty()) {
                JOptionPane.showMessageDialog(null, "You have no active lendings to return.", "No Active lendings",
                        JOptionPane.INFORMATION_MESSAGE);
                return;
            }
            ...
            if (success) {
                ...
                JOptionPane.showMessageDialog(null, "Book returned successfully!", "Return Successful",
                        JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(null, "Failed to return book.", "Return Failed",
                        JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void viewMyCurrentLendings() {
        try {
            ...
            activeLoans = activeLoans.stream().filter(lending -> !lending.isReturned())
                    .collect(java.util.stream.Collectors.toList());

            if (activeLoans.isEmpty()) {
                JOptionPane.showMessageDialog(null, "You have no active loans.", "My Current Loans",
                        JOptionPane.INFORMATION_MESSAGE);
                return;
            }
    ...
    private void viewMyOverdueLendings() {
        try {
            ...
            if (overdueLoans.isEmpty()) {
                JOptionPane.showMessageDialog(null, "You have no overdue loans.", "My Overdue Loans",
                        JOptionPane.INFORMATION_MESSAGE);
                return;
            }
    ...
    private void viewMyDueSoonLendings() {
        try {
            ...
            List<Lending> dueSoonLoans = allLoans.stream()
                    .filter(lending -> !lending.isReturned())
                    .filter(lending -> lending.getDueDate().isBefore(threeDaysFromNow)
                            && lending.getDueDate().isAfter(Instant.now()))
                    .collect(java.util.stream.Collectors.toList());

            if (dueSoonLoans.isEmpty()) {
                JOptionPane.showMessageDialog(null, "You have no loans due soon.", "My Due Soon Loans",
                        JOptionPane.INFORMATION_MESSAGE);
                return;
            }
